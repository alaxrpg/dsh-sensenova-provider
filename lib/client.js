	...
	factory: (require) => {
		...
		*/
		const zh = {
			...
			modelsAutoManaged: "模型目录由服务自动管理，设置页不会手动加入或隐藏模型。",
		...
		const en = {
			...
			modelsAutoManaged: "The model catalog is managed automatically; settings do not manually include or hide models.",
