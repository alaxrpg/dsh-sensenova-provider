	...
	factory: (require) => {
		...
		*/
		...
		function modelSelectionOf(raw) {
			...
			const selection = raw;
			return {
				include: modelIdsOf(selection.include),
				exclude: modelIdsOf(selection.exclude)
			};
		}
		...
		var SenseNovaSettingsController = class {
			...
			stagedActiveAccount;
			stagedConcurrency;
			stagedModelSelectionInclude;
			stagedModelSelectionExclude;
			defaultKeyDraft = "";
			...
			state() {
				...
				const dirty = this.stagedApiBase !== void 0 || this.stagedApiKeyEnv !== void 0 || this.stagedActiveAccount !== void 0 || this.stagedConcurrency !== void 0 || this.stagedModelSelectionInclude !== void 0 || this.stagedModelSelectionExclude !== void 0 || this.defaultKeyDraft !== "" || this.defaultClearStaged || this.addedAccounts.length > 0 || this.removedIds.size > 0 || this.labelDrafts.size > 0 || this.keyDrafts.size > 0 || this.keyClears.size > 0;
				return {
			...
			*/
			...
			discard() {
				...
				this.stagedModelSelectionInclude = void 0;
				this.stagedModelSelectionExclude = void 0;
			...
			async save() {
				...
				try {
					...
					if (this.stagedModelSelectionInclude !== void 0 || this.stagedModelSelectionExclude !== void 0) {
						const current = modelSelectionOf(this.sectionValue("modelSelection"));
						const selection = {
							include: this.stagedModelSelectionInclude !== void 0 ? parseModelIds(this.stagedModelSelectionInclude) : current.include,
							exclude: this.stagedModelSelectionExclude !== void 0 ? parseModelIds(this.stagedModelSelectionExclude) : current.exclude
						};
		...
		*/
		...
		function AdvancedSettings(props) {
			...
			const customizedCount = (props.state.apiBase !== "https://token.sensenova.cn/v1" ? 1 : 0) + (props.state.concurrency !== 1 ? 1 : 0) + (props.state.modelSelectionInclude.length > 0 ? 1 : 0) + (props.state.modelSelectionExclude.length > 0 ? 1 : 0);
						...
						children: [
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								children: [
									/* @__PURE__ */ (0, react_jsx_runtime.jsx)("label", {
										className: "sn-label",
										htmlFor: "sn-model-selection-include",
										children: props.t("modelInclude")
									}),
									/* @__PURE__ */ (0, react_jsx_runtime.jsx)("textarea", {
										...
										disabled: props.disabled,
										spellCheck: false,
										onChange: (event) => props.edit("modelSelectionInclude", event.target.value)
									}),
									/* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
										className: "sn-hint",
										children: props.t("modelIncludeHint")
									})
								]
							}),
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								children: [
									/* @__PURE__ */ (0, react_jsx_runtime.jsx)("label", {
										className: "sn-label",
										htmlFor: "sn-model-selection-exclude",
										children: props.t("modelExclude")
									}),
									/* @__PURE__ */ (0, react_jsx_runtime.jsx)("textarea", {
										...
										disabled: props.disabled,
										spellCheck: false,
										onChange: (event) => props.edit("modelSelectionExclude", event.target.value)
									}),
									/* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
										className: "sn-hint",
										children: props.t("modelExcludeHint")
									})
								]
							})
						]
		...
		function SenseNovaSection(props) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
				...
				children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						className: "sn-card",
						children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(DefaultKeyField, {
							t,
				...
				children: [
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("label", {
							...
							className: "sn-badges",
							children: [
								props.isEffective ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
									className: "sn-badge sn-badgeActive",
									children: t("activeBadgeEffective")
								}) : null,
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
									type: "button",
									className: "sn-reset",
						...
						children: [
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
								...
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(StatusBadge, {
									...
									className: "sn-badge sn-badgeActive",
									children: props.isPinned ? t("activeBadge") : t("activeBadgeEffective")
								}) : null]
							}),
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
								type: "button",
		...
		*/
		...
		function injectPageCss() {
			...
			tag.textContent = [
				...
				".sn-btnPrimary{font-size:13px;line-height:1.4;padding:6px 12px;border-radius:6px;border:1px solid transparent;background:var(--dsw-alias-button-primary-fill,#3b82f6);color:var(--dsw-alias-label-primary-foreground,#fff);cursor:pointer}",
